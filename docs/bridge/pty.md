...
7. **Pane destroyed:** Bridge detects pane removal in poll results, closes the pane stream, closes connected data channel WebSockets with `PANE_DESTROYED`, and removes the pane endpoint.
